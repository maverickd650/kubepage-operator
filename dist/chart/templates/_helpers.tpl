...
*/}}
{{- define "kubepage-operator.fullname" -}}
...
*/}}
{{- define "kubepage-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "kubepage-operator.resourceName" -}}
{{- $fullname := include "kubepage-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "kubepage-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "kubepage-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
